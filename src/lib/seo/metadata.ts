...
const FALLBACK_KEYWORDS = [
  ...
  'resort Tam Dao',
  'genuss tam đảo hotel',
  'genuss tam đảo hideaway retreat',
  'genuss tam dao hideaway retreats',
  'ks genuss tam đảo',
  'khách sạn genuss tam đảo',
  'genuss tam dao hideaway',
  'giá khách sạn genuss tam đảo',
  'genuss hotel tam đảo mấy sao',
  'khách sạn genuss tam dao',
  'vị trí khách sạn genuss tam đảo',
  'khách sạn genuss tam đảo ảnh',
  'bài đánh giá về khách sạn genuss tam đảo',
  'hình ảnh của khách sạn genuss tam đảo',
  'hình ảnh của khách sạn genuss tam đảo',
  'hình ảnh của khách sạn genuss tam đảo',

  'Genuss Tam Dao Hotel',
  'Genuss Tam Dao Resort',
  'Genuss Hideaway Retreat Tam Dao',
  'luxury hotel Tam Dao',
  'best hotel Tam Dao',
  '5 star hotel Tam Dao',
  'Tam Dao accommodation',
  'Tam Dao luxury resort',
  'hotel in Tam Dao Vietnam',
  'Genuss Tam Dao price',
  'Genuss Tam Dao booking',
  'reviews Genuss Tam Dao',
  'Genuss Tam Dao location',
  'images Genuss Tam Dao Hotel',
  'pictures Genuss Tam Dao Resort',
  'Genuss Tam Dao contact number',
  'Genuss Tam Dao star rating',
  'resort near Hanoi',
  'luxury retreat near Hanoi',
];
